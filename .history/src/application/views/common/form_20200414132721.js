            ...
            <Form onSubmit={this.handleSubmit}>
                ...
                <Form.Row>
                    <Form.Group as={Col} controlId="formGridCity">
                        ...
                        <Form.Control value = {this.state.userProfile.city } onChange = {this.handleChange}/>
                    </Form.Group>
                    <Form.Group as={Col} controlId="formCityState">
                        <Form.Label>State</Form.Label>
                        <Form.Control 
                        as="select" value="Choose..." onChange = {this.handleChange}>
                    ...
                    <Form.Group as={Col} controlId="formGridZip">
                        ...
                        <Form.Control value = { this.state.userProfile.zip } onChange = {this.handleChange}/>
                    </Form.Group>
                </Form.Row>
